import{d as _,u as h,r as u,o as p,a as n,b as l,t as m,q as r,e as t,g as v,j as b}from"./index-Cayi-USY.js";const x={class:"min-h-screen bg-gradient-to-b from-gray-100 to-white"},y={key:0,class:"flex justify-center items-center min-h-screen"},U={key:1,class:"flex justify-center items-center min-h-screen text-red-500"},A={key:2},w={class:"max-w-6xl mx-auto px-4 py-16"},T={class:"grid grid-cols-1 md:grid-cols-2 gap-12 items-center"},j={class:"rounded-lg overflow-hidden shadow-xl"},k=["src","alt"],E={class:"text-3xl font-bold mb-6 text-gray-900"},L={class:"space-y-4 text-gray-800"},q=["innerHTML"],B=`
    query getAbout {
