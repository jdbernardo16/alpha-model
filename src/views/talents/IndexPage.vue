<template>
    <div class="bg-gradient-to-br from-stone-900 to-black font-serif p-4">
        <div class="max-w-[1240px] px-4 md:px-10 md:py-0 py-10">
            <h3 class="text-amber-400 uppercase tracking-widest font-light text-xl lg:mb-0 mb-6">
                Talent Spotlight
            </h3>
            <div
                class="w-full bg-black bg-opacity-50 backdrop-blur-sm overflow-hidden shadow-2xl flex flex-col md:flex-row items-center"
            >
                <!-- Image section -->
                <div class="md:w-3/12 relative overflow-hidden h-fit w-full">
                    <router-link to="/talents/babydoll-villegas">
                        ...
                        <div
                            class="absolute bottom-0 left-0 bg-gradient-to-t from-black to-transparent w-full h-full"
                        ></div>
                    </router-link>
                </div>

                <!-- Content section -->
                <div class="md:w-9/12 md:p-8 flex flex-col justify-center">
                    <div class="mb-6">
                    ...
                    <div class="space-y-4 text-gray-200 text-sm mb-8">
                        <p>
                            A rising star in contemporary cinema, Babydoll brings depth and nuance
                            to every role. Her performance in "Whispers of Tomorrow" earned critical
    ...
    <section>
        <div class="max-w-[1440px] m-auto py-10 px-4 lg:px-10">
            <h1 class="text-xl font-light mt-2 mb-6 font-serif">MORE TALENTS</h1>
            <div
                v-if="loading"
